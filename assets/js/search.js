...
const SearchEngine = {
    ...
    data: [
        ...
        { id: 46, title: 'AI基础设施开发修炼手册', url: '/course/ai-infra-dev/', category: '课程', desc: '从硬件到云原生的AI基础设施完整学习路径' },
        { id: 47, title: '节奏大师', url: '/game/rhythm-master/', category: '游戏', desc: '跟着音乐节奏，挑战反应速度' },
        { id: 48, title: '音游练习', url: '/game/music-practice/', category: '游戏', desc: '简单有趣的钢琴音游，练习节奏感' },
        { id: 49, title: '弹射球', url: '/game/gravity-ball/', category: '游戏', desc: '重力物理模拟，精准弹射挑战' },
